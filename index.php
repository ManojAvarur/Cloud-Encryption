...
<html lang="en">
    ...
    <body>
        ...
        <section id="picture" class="d-flex align-items-center justify-content-center">
            <div class = "container">
                <div class="row">
                    <div class="col-xl-6 col-lg-8">
                    </div>
                    <div class="col-xl-6 col-lg-8 blk">
                        <div class="typewriter">
                            <h1>En||De-code your data....</h1>
                            <br>
                            <div class="text-center">
                                <a href = "encrypt.php"><button type="button" class="btn btn-outline-new btn-lg">Data Encryption</button></a>
                                <br>
                                <br>
                                <a href = "decrypt.html"><button type="button" class="btn btn-outline-new btn-lg">Data Decryption</button></a>
                            </div>
                        </div>
                    </div>
                </div>

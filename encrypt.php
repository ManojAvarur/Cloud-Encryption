...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 blk">
                    ...
                    <form style="width: 100%" method="POST" action="edownload.php" enctype="multipart/form-data">
                        ...
                        <br>
                        <div>
                            <input type="radio" name="passwordType" value="createNew" id="newPass" onclick="newPassword()" checked='checked'>
                            <label for="newPass">
                                <p class="rad">Generate New Password</p>
                            </label>
                            <br>
                        ...
                        <div class="text-center">
                            <input type="submit" class="btn btn-outline-new btn-lg" name="submit" value="Encrypt">
                        </div>
                    </form>
    ...
    <script>
        ...
        newPassword = () => {
            ...
            document.getElementById('userPassType').classList.add('isDisabled');
        }

        userPassword = () => {
            document.getElementById('userPassType').disabled = false;
            document.getElementById('userPassType').required = true;
            document.getElementById('userPassType').classList.remove('isDisabled');
        }
